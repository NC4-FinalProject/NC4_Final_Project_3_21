...
public class QFriend extends EntityPathBase<Friend> {
    ...
    private static final long serialVersionUID = 701987101L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QFriend friend = new QFriend("friend");

    public final DateTimePath<java.time.LocalDateTime> agreeTime = createDateTime("agreeTime", java.time.LocalDateTime.class);
